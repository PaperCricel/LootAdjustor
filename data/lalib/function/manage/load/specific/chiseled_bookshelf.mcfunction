...
function lalib:manage/load/specific/chiseled_bookshelf/occupied
function lalib:manage/load/specific/chiseled_bookshelf/replace with storage lalib:temp update
