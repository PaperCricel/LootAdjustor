...
function lalib:import_loots/return/chiseled_bookshelf/facing
function lalib:import_loots/return/chiseled_bookshelf/occupied
function lalib:import_loots/return/chiseled_bookshelf/replace with storage lalib:temp update
