...
$give @s paper[\
    ...
    lore=[[{"italic":false,"color":"white","text":""},{"color":"gray","text":"Left Click:"}],[{"italic":false,"color":"white","text":""},{"color":"gray","text":"◆ "},{"color":"#e8b764","text":"Add/Save"},{"color":"gray","text":" container to "},{"color":"#e8b764","text":"Loot Storage"},{"color":"gray","text":"."}],[{"italic":false,"color":"white","text":""}],[{"italic":false,"color":"white","text":""},{"color":"gray","text":"Right Click:"}],[{"italic":false,"color":"white","text":""},{"color":"gray","text":"◆ "},{"color":"#e8b764","text":"Remove"},{"color":"gray","text":" container from "},{"color":"#e8b764","text":"Loot Storage"},{"color":"gray","text":"."}],[{"italic":false,"color":"white","text":""}],[{"italic":false,"color":"white","text":""},{"color":"gray","text":"Press ","extra":[{"keybind":"key.swapOffhand"},":"]}],[{"italic":false,"color":"white","text":""},{"color":"gray","text":"◆ "},{"color":"#e8b764","text":"Open"},{"color":"gray","text":" settings about "},{"color":"#e8b764","text":"Loot Storage"},{"color":"gray","text":"."}]],\
